...
public class SearchCategoryLevelFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        myView = inflater.inflate(R.layout.fragment_search_category_level, container, false);
        ...
        fragment = new SearchLevelFragment();
        bundle = new Bundle();
